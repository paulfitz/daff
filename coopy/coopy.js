			...
			if(!mod.rem) {
				if(mod.add) {
					...
					while( $it0.hasNext() ) {
						...
						if(offset != null && offset >= 0) this.source.setCell(offset,mod.destRow,this.patch.getCell(c,mod.patchRow));
					}
				} else if(mod.update) {
		...
		while(true) {
			...
			case 116:
				...
				if((function($this) {
					var $r;
					var index = $this.pos++;
					$r = $this.str.charCodeAt(index);
					return $r;
				}(this)) != 114 || (function($this) {
					var $r;
					var index = $this.pos++;
					$r = $this.str.charCodeAt(index);
					return $r;
				}(this)) != 117 || (function($this) {
					var $r;
					var index = $this.pos++;
					$r = $this.str.charCodeAt(index);
					return $r;
			...
			case 102:
				...
				if((function($this) {
					...
					$r = $this.str.charCodeAt(index);
					return $r;
				}(this)) != 97 || (function($this) {
					var $r;
					var index = $this.pos++;
					$r = $this.str.charCodeAt(index);
					return $r;
				}(this)) != 108 || (function($this) {
					var $r;
					var index = $this.pos++;
					$r = $this.str.charCodeAt(index);
					return $r;
				}(this)) != 115 || (function($this) {
					var $r;
					var index = $this.pos++;
					$r = $this.str.charCodeAt(index);
					return $r;
